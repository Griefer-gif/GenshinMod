...
namespace GenshinMod.Items.DebugShtuff
{
	...
	class TestGunHydro : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Test gun Hydro");
			Tooltip.SetDefault("Shoot shoot bang bang");
		}
		...
		public override bool Shoot(Player player, ProjectileSource_Item_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
		{
			Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<HydroArrow>(), damage, knockback, player.whoAmI);
			return false;
		}
	}
